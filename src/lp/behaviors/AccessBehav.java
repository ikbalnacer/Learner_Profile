...
public class AccessBehav
{
	private AccessAgent responsible;
	private AccessGUI gui;

	public AccessBehav(AccessAgent responsible, AccessGUI gui)
	{
...
//					else
//					{
//						System.out.println(response.getPerformative() == ACLMessage.REQUEST ? "fail" : "other");
